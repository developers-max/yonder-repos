...
export default function LoginPage() {
  return (
    <div className="flex flex-col min-h-svh bg-gray-50 md:bg-[url('/home.avif')] md:bg-cover md:bg-center dark:brightness-[0.2] dark:grayscale">
      ...
      <div className="flex justify-center pt-8 pb-4 md:fixed md:top-8 md:left-0 md:right-0 md:pt-0 md:pb-0">
      ...
      <div className="flex-1 flex items-center justify-center px-4 pb-8 md:px-6">
